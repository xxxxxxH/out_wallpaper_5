...
class Fragment1 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.layout_f1, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        dialog?.show()
        RetrofitUtils.get().retrofit().create(RequestService::class.java).getData().enqueue(object :
            Callback<ArrayList<DataEntity>> {
    ...
    fun onEvent(event: MessageEvent) {
        ...
        if (msg[0] == "c1") {
            ...
            val i = Intent(activity, PreviewActivity::class.java)
